    ...
    return(
      <>
        <div className='patentlandingpage'>
            <video src="https://cellixbio-assets.s3.ap-south-1.amazonaws.com/Web+Images/Bulbs.mp4" autoPlay muted loop className='patents_video_bg' type="video/mp4"/>
        ...
        {/* <div>
            <div className='LeaderContainer'>
                <div className='LeaderContainer1'>
                    ...
                    <div className='LeaderTitleContainer'>
                        <h1 className='LeaderTitle'>Mahesh Kandula</h1><p className='Leadertext'>Founder</p>
                    </div>
                </div>
            ...
            <div className='LeadershipContainer'>
                ...
                <div className='LeaderContainer2'>
                    <div className='LeaderSubTitleContainer'> 
                    <div className='DescContainerh3'><span></span>
                        <span className="WWDh3">Dr. Douglas Greene</span><span></span>
                    </div>
                    </div>  
                                <hr className='LeaderHR'></hr>
                    <div className='LeaderMsgContainer'>
            ...
            <div className='LeaderContainer'>
                ...
                <div className='LeaderContainer2'>
                    <div className='LeaderSubTitleContainer'> 
                    <div className='DescContainerh3'><span></span>
                        <span className="WWDh3">Paul Jeffrey</span><span></span>
                    </div>
                    </div>  
                                <hr className='LeaderHR'></hr>
                    <div className='LeaderMsgContainer'>
                        <p className='LeaderMsg'>Paul Jeffrey is an accomplished Pharmaceutical business consultant and leader with demonstrated new product development and business development capabilities. He has over 30 years of industry experience building product value by leading global teams and creating and implementing clinical and marketing programs to maximize commercial positioning and launch success. He has led commercial development team and alliance partnerships while at Pfizer as VP of Global Commercial Development group.</p>
                    </div>
                </div>
            </div>
        </div> */}
            ...
            <div class="wrapper">
                <div class="team">
                    <div class="team_member">
                        ...
                        <p>Mahesh brings over 18 years of scientific and entrepreneurial experience in the life science industry. Mr. Kandula has been named an inventor on 112 United States Patents and Applications and, more than 635 International Patent Applications. Mr. Kandula received his Master of Technology degree from IIT Kharagpur.</p>
                    </div>
                    
                    <div class="team_member">
                        <div class="team_img">
                            <img src="https://cellixbio-assets.s3.ap-south-1.amazonaws.com/Web+Images/CellixBio.Leadership.SubbuApparsundaram.PNG" alt="Team_image"></img>
                        </div>
                        <h3>Subbu Apparsundaram</h3>
            ...
            <div class="wrapper">
                ...
                <div class="team">
                    <div class="team_member">
                        <div class="team_img">
                            <img src="https://cellixbio-assets.s3.ap-south-1.amazonaws.com/Web+Images/CellixBio.Leadership.FrankDiana.PNG" alt="Team_image"></img>
                        </div>
                        <h3>Frank Diana</h3>
                    ...
                    <div class="team_member">
                        <div class="team_img">
                            <img src="https://cellixbio-assets.s3.ap-south-1.amazonaws.com/Web+Images/CellixBio.Leadership.Mudher.PNG" alt="Team_image"></img>
                        </div>
                        <h3>Dr. Mudher Albassam</h3>
                    ...
                    <div class="team_member">
                        <div class="team_img">
                            <img src="https://cellixbio-assets.s3.ap-south-1.amazonaws.com/Web+Images/CellixBio.Leadership.Douglas.png" alt="Team_image"></img>
                        </div>
                        <h3>Dr. Douglas Greene</h3>
                    ...
                    <div class="team_member">
                        <div class="team_img">
                            <img src="https://cellixbio-assets.s3.ap-south-1.amazonaws.com/Web+Images/CellixBio.Leadership.PaulJeffery.PNG" alt="Team_image"></img>
                        </div>
                        <h3>Paul Jeffrey</h3>
