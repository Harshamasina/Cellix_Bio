function Leadership(){
    return(
        <div>
            <h3 className="Lh3">OUR LEADERSHIP</h3>
            <div>
                <h4 className="Lh4">Management Team</h4>
            </div>
            {/* <div>
                <img src="https://www.cellixbio.com/images/team/MaheshKandula1.jpg" alt="L1"></img>
            </div> */}
            <div className="LulContainer">
                <ul className="Lul">
                    <li>Mahesh Kandula</li>
                    <li>Director</li>
                    <li>Drug Design and Development, Innovation & IP</li>
                    <li>Founder</li>
                </ul>
            </div>
